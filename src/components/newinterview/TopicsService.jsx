...
const TopicsService = () => {
  ...
  const handleSubmit = async () => {
    // Prepare the interview data using the controller
  ...
  addCustomQuestion={(newQuestion) => {
    // Add the question to customQuestions
    setCustomQuestions((prevQuestions) => [...prevQuestions, newQuestion]);

    // Automatically tick the checkbox by adding the question to selectedQuestions
