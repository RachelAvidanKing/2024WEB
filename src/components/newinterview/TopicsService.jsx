...
const TopicsService = () => {
  ...
  // State to store the topic input for generating questions
  const [topicInput, setTopicInput] = useState("");
  // State to store the questions generated by the AI
  const [generatedQuestions, setGeneratedQuestions] = useState([]);
  // State to store the selected questions from the generated list
  const [selectedQuestions, setSelectedQuestions] = useState([]);
  // State to store the answers to selected or custom questions
  const [answers, setAnswers] = useState({});
  // State to indicate if the application is loading (e.g., generating questions)
  const [isLoading, setIsLoading] = useState(false);
  // State to store custom questions added by the user
  ...
  // Handler to update interviewee details (name and date)
  ...
  // Handler to toggle selection of a question
  ...
  // Function to prepare and submit the interview data
  ...
  return (
    <div className=" dark:bg-gray-900 transition-colors duration-200">
      <div className="max-w-full p-6 sm:p-10">
        ...
        {/* Instruction for selecting questions */}
        <h2 className="text-3xl sm:text-4xl font-bold text-purple-800 dark:text-purple-400 mb-8">
          Please tick the questions you would like to include in the interview ☑️
        </h2>

        {/* Input fields for interviewee name and date */}
        ...
        {/* Section for AI Question Generator */}
        ...
        {/* Section to display and handle custom questions */}
        <div className="mb-12 p-6 bg-white dark:bg-gray-800 rounded-lg">
          <CustomQuestionInput
        ...
        {/* Buttons for saving or downloading the interview */}
